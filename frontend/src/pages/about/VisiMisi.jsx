    ...
    <div className="pt-32 pb-20 min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="bg-emerald-50 rounded-xl p-8 shadow-sm text-left">
          ...
          <div className="prose prose-emerald text-gray-700 mb-8 max-w-none text-left" dangerouslySetInnerHTML={{ __html: data.vision || "" }}></div>
          
          <h2 className="text-2xl font-bold text-emerald-800 mb-4">Misi</h2>
          <div className="prose prose-emerald text-gray-700 mb-8 max-w-none text-left" dangerouslySetInnerHTML={{ __html: data.mission || "" }}></div>

          <h2 className="text-2xl font-bold text-emerald-800 mb-4">Motto</h2>
          <p className="text-xl font-medium italic text-gray-600">"{data.motto || ""}"</p>
        </div>
      </div>
    </div>
  );
