...
export default function BeritaEdit() {
  ...
  if (loading) return <p className="text-center font-bold text-gray-400 mt-20 animate-pulse">Memuat data berita...</p>;
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-extrabold text-gray-900 border-l-8 border-emerald-600 pl-4">Edit Berita</h1>
          <p className="text-gray-500 text-sm mt-1 pl-6">Perbarui informasi berita yang dipublikasikan</p>
        </div>
      </div>
